...
function onReady() {
  ...
  document
    .getElementById("arcane-scepter")
    .addEventListener("click", arcaneScepter);
  document.getElementById("entangle").addEventListener("click", entangle);
  document
    .getElementById("dragon-blade")
    .addEventListener("click", dragonBlade);
...
// * Will be completed by two other functions: regen()/stopRegen() if over or under 50
